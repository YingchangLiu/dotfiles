...
theme.icon_dir                                  = os.getenv("HOME") .. "/.config/awesome/themes/kelen/icons"
theme.wallpaper                                 = os.getenv("HOME") .. "/.config/awesome/themes/kelen/wall.png"
...
function theme.at_screen_connect(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, height = dpi(32), opacity = 0.8 })
   ...
   --[[ 
    ...
    s.mybottomwibox = awful.wibar({ position = "bottom", screen = s, border_width = dpi(0), height = dpi(32),opacity = 0.8 })
